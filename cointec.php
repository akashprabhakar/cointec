<?php 
	...
	$m->From = 'akashmudliyar@gmail.com';
	$m->FromName = 'Admin';
	...
	$m->Body .= '<h4>Total Score -><b style="color:#f00">'.$total.'</b>/179</p>';
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="cointec_history.php" class="btn btn-info" style="color:#fff;font-weight:bold;">Check History</a></li>
        <li><a href="#" class="btn btn-danger" style="color:#fff;font-weight:bold;">Cointec</a></li>
      </ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>
	...
	<div class="container">
		...
		<p style="color:#A8A8A8;">Please complete the following questionnaire. This will generate your COINTEC score and you will be able to log in with the participants name and your mail address in future to track your history.</p>

		<div class="row">
			<div class="col-md-12">
				
				
				<form action="" method="post" id="cointec">
				<!-- section 1 start ---->
				<div class="row">
					<div class="col-md-8">
					<h3 class="page-header text-center">Personal Details</h3>
				<div class="col-md-6 form-group">
					<input type="text" name="username" id="username" placeholder="Enter first name of person being assessed.." class="form-control"/>	
				...
				<h3 class="page-header text-center">Neurological signs and symptoms.</h3>
					<div class="col-md-6 form-group">
					    ...
					    <select id="balancevertigo" name="balancevertigo" class="form-control required" required>
					...
					<div class="col-md-6 form-group">
					    ...
					    <select id="tempreg" name="tempreg" class="form-control required" required>
						  <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
					...
					<div class="col-md-6 form-group">
					    ...
					    <select required id="noise" name="noise" class="form-control required">
						  <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
					...
					<div class="col-md-6 form-group">
					    ...
					    <select id="light" name="light" class="form-control required" required>
						  <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
					...
					<div class="col-md-6 form-group">
					    ...
					    <select id="headaches" name="headaches" class="form-control required" required>
						  <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
					...
					<div class="col-md-6 form-group">
					    ...
					    <select id="vision" name="vision" class="form-control required" required>
						  <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
					...
					<div class="col-md-6 form-group">
					    ...
					    <select id="coma" name="coma" class="form-control required" required>
						  <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
					...
					<div class="col-md-6 form-group">
					    ...
					    <select id="seizures" name="seizures" class="form-control required" required>
						  <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
					...
					<div class="col-md-6 form-group">
					    ...
					    <select id="sleep" name="sleep" class="form-control required" required>
						  <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
					...
					<h3 class="page-header text-center">Cardiovascular signs and symptoms.</h3>
						<div class="col-md-6 form-group">
						    ...
						    <select id="chest_pain" name="chest_pain" class="form-control required" required>
							  <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
						...
						<div class="col-md-6 form-group">
						    ...
						    <select id="low_blood" name="low_blood" class="form-control required" required>
							  <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
						...
						<div class="col-md-6 form-group">
						    ...
						    <select id="feetburn" name="feetburn" class="form-control required" required>
							  <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
						...
						<div class="col-md-6 form-group">
						    ...
						    <select id="poor_digest" name="poor_digest" class="form-control required" required>
							 <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
					...
					<div class="row">
						...
						<div class="col-md-6 form-group">
						    ...
						    <select id="weakness" name="weakness" class="form-control required" required>
							 <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
						...
						<div class="col-md-6 form-group">
						    ...
						    <select id="spasms" name="spasms" class="form-control required" required>
							  <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
						...
						<div class="col-md-6 form-group">
						    ...
						    <select id="swallowing" name="swallowing" class="form-control required" required>
							  <option value="">Choose a symptom</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
						  <option value="Mild and constant symptoms">Mild and constant symptoms</option>
						...
						<div class="col-md-6 form-group">
						    ...
						    <select id="tingling" name="tingling" class="form-control required" required>
							  <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
						...
						<div class="col-md-6 form-group">
						    ...
						    <select id="twitching" name="twitching" class="form-control required" required>
							  <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
					...
					<div class="row">
						...
						<div class="col-md-6 form-group">
						    ...
						    <select id="disjointed" name="disjointed" class="form-control required" required>
							  <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
						...
						<div class="col-md-6 form-group">
						    ...
						    <select id="delay_speech" name="delay_speech" class="form-control required" required>
							  <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
						...
						<div class="col-md-6 form-group">
						    ...
						    <select id="handwriting" name="handwriting" class="form-control required" required>
							 <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
						...
						<div class="col-md-6 form-group">
						    ...
						    <select id="morethan1" name="morethan1" class="form-control required" required>
							  <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
						...
						<div class="col-md-6 form-group">
						    ...
						    <select id="basic_maths" name="basic_maths" class="form-control required" required>
							  <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
						...
						<div class="col-md-6 form-group">
						    ...
						    <select id="spacial_awarness" name="spacial_awarness" class="form-control required" required>
							  <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
						...
						<div class="col-md-6 form-group">
						    ...
						    <select id="rem_faces" name="rem_faces" class="form-control required" required>
							 <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
					...
					<div class="row">
						...
						<div class="col-md-6 form-group">
						    ...
						    <select id="nauseated" name="nauseated" class="form-control required" required>
							  <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
						...
						<div class="col-md-6 form-group">
						    ...
						    <select id="tenderness" name="tenderness" class="form-control required" required>
							  <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
						...
						<div class="col-md-6 form-group" style="margin-top:-20px;">
						    ...
						    <select id="fdallergies" name="fdallergies" class="form-control required" required>
							 <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
						...
						<div class="col-md-6 form-group" >
						    ...
						    <select id="challergies" name="challergies" class="form-control required" required>
							 <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
						...
						<div class="col-md-6 form-group" style="margin-top:-20px;">
						    ...
						    <select id="blotchiness" name="blotchiness" class="form-control required" required>
							 <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
						...
						<div class="col-md-6 form-group">
						    ...
						    <select id="rigidity" name="rigidity" class="form-control required" required>
							  <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
						...
						<div class="col-md-6 form-group">
						    ...
						    <select id="exertionf" name="exertionf" class="form-control required" required>
							  <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
						...
						<div class="col-md-6 form-group" style="margin-top:-10px;">
						    ...
						    <select id="exertions" name="exertions" class="form-control required" required>
							  <option value="">Choose a symptom</option>
						  <option value="No symptoms">No symptoms</option>
						  <option value="Mild and occasional symptoms">Mild and occasional symptoms</option>
						  <option value="Mild and regular symptoms">Mild and regular symptoms</option>
					...
					<div class="row">
						<div class="col-md-8">
						<p class="text-muted page-header">Please use this space to record any changes in your treatment since the last time. This will enable you to track what has worked and what hasn't.</p>
