  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="atec.php" class="btn btn-info" style="color:#fff;font-weight:bold;">Take Atec Test</a></li>
        <!-- <li class="dropdown">
	...
	<form action="" method="post">
				...
				if(isset($_POST['submit'])){
					...
					if (isset($_POST["email"]) && !empty($_POST["email"])) {
			  		...
			  		$records = get_atec_history($name,$email);
			...
			<table class="table table-bordered">
			    <thead>
			      <tr>
			        <th>Date </th>
			        <th>Username </th>
			        <th>Speech, Language and Communication</th>
			        <th>Sociability Maximum </th>
			        <th>Cognitive and sensory awareness </th>
			        <th>Health and physical behaviour</th>
			        <th>Overall Score</th>
			        <th>Feedback</th>
			      </tr>
			    </thead>
			    ...
			    <?php foreach($records as $record) { ?>
			      <tr>
			        ...
			        <td><?php echo $record['subtotala1']; ?></td>
			        <td><?php echo $record['subtotala2']; ?></td>
			        <td><?php echo $record['subtotala3']; ?></td>
			        <td><?php echo $record['subtotala4']; ?></td>
			        <td><?php echo $record['atectotal']; ?></td>
